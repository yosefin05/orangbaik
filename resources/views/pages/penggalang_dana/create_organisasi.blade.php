...
<head>
    ...
    <title>Verifikasi Organisasi - OrangBaik.id</title>
...
<main class="verify-page">
        ...
        <div class="container">
            <div class="verify-heading">
                ...
                <p>
                    ...
                    Data yang diberikan akan digunakan untuk verifikasi akun dan pengelolaan campaign di OrangBaik.id.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="verify-section">
        <div class="container">
            ...
            <form
                class="verify-form"
                action="{{ route('penggalang_dana.organisasi.store') }}"
                method="POST"
                ...
                <section class="verify-card">
                    <div class="verify-card-header">
                        ...
                        <p>
                            Informasi kontak dan media sosial membantu membangun transparansi
                            serta kredibilitas organisasi.
                        </p>
                    </div>
                    ...
                    <div class="verify-grid-2">
                        <label class="verify-field">
                            ...
                            <input
                                ...
                                placeholder="Masukkan nomor hotline organisasi">
                        </label>
