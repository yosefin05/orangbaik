        ...
        <div class="container zakat-hero-layout">
            ...
            <div class="zakat-hero-content">
                ...
                <div class="zakat-hero-actions">
                    ...
                    <a
                        href="https://baznas.go.id/assets/pdf/ppid/tentang%20zakat/SK_01_2024.pdf"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="zakat-secondary-link">
                        Pelajari Zakat
                    </a>
                </div>
            </div>
            ...
            <div class="zakat-hero-image">
                <img
                    src="{{ asset('assets/zakat.svg') }}"
                    alt="Ilustrasi kalkulator zakat">
            </div>
