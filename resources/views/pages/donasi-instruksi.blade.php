    ...
    <div class="instruction-container">
        ...
        <div class="card">
            <div style="display:flex; justify-content:space-between; align-items:center;">
                <div>
                    <span style="font-size:0.8125rem; color:#64748b;">Order ID:
                        <code>{{ $pembayaran->order_id }}</code></span>
            ...
            <div class="amount-box">
                ...
                <div class="amount-value" id="nominal-transfer">Rp {{ number_format($donasi->nominal, 0, ',', '.') }}
                </div>
            ...
            <div>
                ...
                <ol class="steps-list">
                    ...
                    @else
                        <li>Transfer dana sejumlah <strong>Rp {{ number_format($donasi->nominal, 0, ',', '.') }}</strong> ke
                            nomor rekening di atas.</li>
            ...
            @if ($pembayaran->payment_type === 'transfer' || $pembayaran->isManualTransfer())
                <div class="upload-section">
                    ...
                    @if ($pembayaran->transaction_status === 'pending')
                        <form action="{{ route('donasi.bayar.upload_bukti', $pembayaran->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="file-input-wrapper">
                                <input type="file" name="bukti_transfer" accept="image/jpeg,image/png,image/jpg,image/webp"
                                    required style="font-size:0.875rem; width:100%;">
                    ...
                    @elseif ($pembayaran->transaction_status === 'settlement')
                        <div class="alert alert-success" style="margin-top:0.75rem;">
                            <i class="bi bi-check-circle-fill"></i> Pembayaran telah diverifikasi oleh admin. Terima kasih atas
                            donasi Anda!
                        </div>
                    @endif
                </div>
