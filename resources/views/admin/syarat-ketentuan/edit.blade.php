...
@section('page-title', 'Edit Syarat & Ketentuan')
...
@section('content')
    ...
    <section class="ob-card ob-card-lg form-card">
        ...
        <div class="card-topbar">
            <div>
                ...
                <p class="card-subtitle">
                    Perbarui bagian "{{ $item->judul }}" pada halaman syarat dan ketentuan.
                </p>
            </div>
        ...
        <form action="{{ route('admin.syarat-ketentuan.update', $item) }}" method="POST">
            @csrf
            @method('PUT')
